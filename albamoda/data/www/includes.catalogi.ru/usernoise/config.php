...
$config = array();
// Form options
$config['home'] = 'http://catalogi.ru/header/usernoise'; // Change this if you put Usernoise in an another folder.
...
$config['email.to'] = 'catalogi.ru.translate@gmail.com'; //Email address you want notifications to be sent to.
$config['email.smtp.password'] = 'klopklop'; // Your email password.
