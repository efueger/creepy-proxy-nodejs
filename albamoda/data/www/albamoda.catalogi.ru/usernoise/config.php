...
$config = array();
// Form options
$config['home'] = '/usernoise'; // Change this if you put Usernoise in an another folder.
...
$config['email.to'] = 'feedback@catalogi.ru'; //Email address you want notifications to be sent to.
$config['email.smtp.password'] = 'oAB1YEEU'; // Your email password.
...
$config['email.from.name'] = 'Catalogi'; // Human readable FROM name.
$config['email.subject'] = 'Отзыв'; // Notification email subject.
$config['email.smtp.enable'] = true; // Use PHP mail() function by default. Please note that SMTP delivery works MUCH better usually.
$config['email.smtp.host'] = 'mail.catalogi.ru'; // Default to Gmail.
$config['email.smtp.secure'] = 'null'; // Allowed values are null, 'ssl' and 'tls'. SSL is best for Gmail.
$config['email.smtp.port'] = '25'; //SSL SMTP port. 25 for non-secure connections, 465 for SSL connections, 589 for TLS connections.
