...
function onlinekat_open(linkContent, linkTarget, payload) {
		...
		switch(linkTarget){
			case  "_javascript":
			{
				linkContent = "http://www.janvanderstorm.catalogi.ru/janvanderstorm/de/s?_sb=true&query="+linkContent;
...
function addToBasket(linkContent) {
		...
		top.location.href = 'http://www.janvanderstorm.catalogi.ru/shop/s?query='+linkContent+'&searchSubmit=&fulltext-search=true&fromSearch=true';
}
