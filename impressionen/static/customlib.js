...
function onlinekat_open(linkContent, linkTarget, payload) {
		...
		switch(linkTarget){
			case  "_javascript":
			{
				linkContent = "http://www.impressionen.catalogi.ru/impressionen/de/s?_sb=true&query="+linkContent;
...
function addToBasket(linkContent) {
		...
		top.location.href = 'http://www.impressionen.catalogi.ru/shop/s?query='+linkContent+'&searchSubmit=&fulltext-search=true&fromSearch=true';
}
