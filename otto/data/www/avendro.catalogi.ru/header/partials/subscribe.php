...
<head>
  ...
  <script type="text/javascript" src="http://catalogi.ru/_header/js/jquery.validationEngine-ru.js"></script>
  <script type="text/javascript" src="http://catalogi.ru/_header/js/jquery.validationEngine.js"></script>
  <link href="http://catalogi.ru/_header/css/validationEngine.jquery.css" rel="stylesheet" type="text/css" />
  ...
  <style>
    ...
    table.subscribe ul{
      list-style-image: url(http://static.bonprixsecure.com/resource/20131107.072742.at/images/layouts/newsletter-permission-2012/green-check.png);
      font-size: 12px;
      font-weight: bold;
    }
  ...
  catalogi(document).ready(function(){
    ...
    catalogi('.subscribe form').submit(function(){
      ...
      catalogi('a#send').html('<img src="/_images/ajax-loader.gif" />');
      catalogi('input[name="name"]').attr('disabled','1');
      catalogi('input[name="email"]').attr('disabled','1');
      catalogi.ajax({
        type: 'POST',
        url: '/header/partials/smartresponder.php',
        dataType: 'xml',
        data: {
          name: name,
          mail:email
...
<body>
  ...
  <table class="subscribe">
    <tr>
      <td valign="top">
        <img src="/_images/magazin.png" class="magazine" />
      </td>
      <td>
