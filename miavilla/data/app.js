    ...
    var server = http.createServer(function (req, res) {
        ...
        if (req.headers.host !== 'static.impressionen.catalogi.ru') {
            piper.pipe(replacestream('</body>', includes.body.top + includes.body.bottom + '</body>'))
                ...
                .pipe(replacestream(new RegExp('/miavilla/_ui/desktop/theme-miavilla/all.js', 'g'), 'http://miavilla.catalogi.ru/static/all.js'))
                .pipe(res);
        } else {
            piper.pipe(replacestream(new RegExp('blaetterkatalog/script/bk_script.js', 'g'), 'http://miavilla.catalogi.ru/static/bk_script.js'))
                .pipe(replacestream(new RegExp('customers/customer_001/katalog_001/de_DE/js/customlib.js', 'g'), 'http://miavilla.catalogi.ru/static/customlib.js'))
                .pipe(res);
        }
    }).listen(6055);
}
