module.exports = function(catalog, param, width){
  return {
    head :[
      '<meta name="google" value="notranslate" />',
      '<meta name="google-translate-customization" content="9c134fd809744d62-760cedc62a418879-g2eb8952935880b23-15" />',
    ...
    body: {
      top: [
        ...
        '<iframe src="http://includes.catalogi.ru/new/index.php?'+param+'" width="'+width+'px" height="120px" frameborder="0" name="_head" id="iframe"/>'
      ].join("\n"),
