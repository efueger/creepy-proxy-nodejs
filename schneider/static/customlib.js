...
function onlinekat_open(linkContent, linkTarget, payload) {
		...
		switch(linkTarget){
			case  "_javascript":
			{
				linkContent = "http://www.schneider.catalogi.ru/schneider/de/s?_sb=true&query="+linkContent;
...
function addToBasket(linkContent) {
		...
		top.location.href = 'http://www.schneider.catalogi.ru/shop/s?query='+linkContent+'&searchSubmit=&fulltext-search=true&fromSearch=true';
}
