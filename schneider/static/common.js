...
catalogi.parse = function() {
    ...
    // Меню
    catalogi('#meta-nav > ul > li:eq(0)').remove();

    catalogi('a[data-etracker-event*="Header, Metanavi, Katalog bestellen"]').attr('href', '#')
    ...
    catalogi('a[data-etracker-event*="Header, Metanavi, Newsletter "]').attr('href', '#')
        ...
        .removeAttr('data-etracker-event')
        .removeAttr('data-etracker-campaign');
    catalogi('a[data-etracker-event*="Header, Metanavi, Direkt bestellen"]').parent().parent().remove();
    catalogi('a[data-etracker-event*="Header, Metanavi, Online-Kataloge"]')
