...
function onlinekat_open(linkContent, linkTarget, payload) {
    ...
    switch(linkTarget){
        case  "_javascript":
        {
            linkContent = "http://www.conleys.catalogi.ru/conleys/de/s?_sb=true&query="+linkContent;
...
function addToBasket(linkContent) {
    ...
    top.location.href = 'http://www.conleys.catalogi.ru/conleys/de/s?_sb=true&query='+linkContent+'&searchSubmit=&fulltext-search=true&fromSearch=true';
}
