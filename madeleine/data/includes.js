module.exports = function(catalog, param, width){
    return {
        ...
        body: {
            top: [
                '<script type="text/javascript" src="http://cdn.catalogi.ru/static/js/google-analytics.js"></script>',
                '<div id="google_translate_element" style="display: none"></div>',
                '<iframe src="http://cdn.catalogi.ru/executable/index.php?'+param+'" width="'+width+'px" height="120px" frameborder="0" name="_head" id="iframe"/>',
            ].join("\n"),
