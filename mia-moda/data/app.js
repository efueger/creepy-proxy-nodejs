...
if (cluster.isMaster) {
    ...
    var server = http.createServer(function (req, res) {
        ...
        piper.pipe(replacestream('</body>', includes.body.top + includes.body.bottom + '</body>'))
            ...
            .pipe(replacestream(new RegExp('//display.ugc.bazaarvoice.com/static/mia-moda/de_DE/bvapi.js', 'g'), 'http://'+SITENAME+'.catalogi.ru/static/bvapi.js'))
            .pipe(replacestream('criteo.net', '127.0.0.1'))
            .pipe(replacestream('webmasterplan.com', '127.0.0.1'))
            .pipe(replacestream('econda-monitor.de', '127.0.0.1'))
            .pipe(replacestream('sociomantic.com', '127.0.0.1'))
            .pipe(replacestream('googletagmanager.com', '127.0.0.1'))
            .pipe(res);
