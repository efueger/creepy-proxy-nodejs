"version:26";
"build:0.24.1";
"date:Wed Mar 23 2016 10:25:24 GMT+0000 (UTC)";
!function(e) {
    function t(r) {
        if (n[r])
            return n[r].exports;
        ...
        r = [n(3), n(2)],
            i = function(e, t) {
                ...
                try {
                    ...
                    var s = n(5);
                    t = n(6)(t),
                    i && i.call(r, "scout-to-render");
                    var o = t._internal;
                    o.startTime = new Date,
                        o.apiCache = {},
                        o.fbVersion = s.version,
                        o.uiVersion = s.firebirdVersion,
                        o.protocol = "https:" === e.location.protocol ? "https:" : "http:",
                        o.preview = !1,
                        o.asEvented = n(7),
                        o.ie = n(8),
                        o._ = n(9),
                        t._bvapijs = !0,
                        t._options = s.rawFirebirdConfig;
                    var u = t.performance = n(10);
                    u.mark("scoutStart"),
                        t = n(15)(t),
                        t.options = n(16)(t),
                        n(18)(t);
                    var a = t.extensions = n(21);
                    t._internal.extensionsRegistry = n(22)(a),
                        t._internal.preload = n(23)(t),
                        e.$BV = n(24)(t, e.$BV);
                    var f = n(25);
                    f.init(t, "RatingsAndReviews", "production" !== t.options.environment),
                        u.mark("scoutEnd")
                } catch (l) {
                    r && r.log && (r.log(l.stack),
                        r.log("Error loading Bazaarvoice", l))
                }
            }
                .apply(t, r),
            ...
            rawFirebirdConfig: {
                ...
                configs: {
                    13384: {
                        ...
                        apiconfig: {
                            limit: 10,
                            passkey: "9ro13m3wxgw846x5bsgvz59q7",
                            ...
                            contentLocales: ["de_DE"],
                            displaycode: "13384-de_de"
                        },
                        allowedDomains: [{
                            domainAddress: ".mia-moda.de",
                            ...
                            thirdPartyCookieEnabled: !0,
                            domainAddress: ".mia-moda.ch"
                        }, {
                            thirdPartyCookieEnabled: !0,
                            domainAddress: ".piazzablu.com"
                        }, {
                            thirdPartyCookieEnabled: !0,
                            domainAddress: ".mia-moda.fr"
                        }, {
                            thirdPartyCookieEnabled: !0,
                            domainAddress: ".beta.mia-moda.de"
                        }],
                        build: !0,
                        statsTypes: ["Reviews"],
                        externalFeatures: [],
                        ...
                        homePageUrl: "http://www.mia-moda.de",
                        container: {
                            url: "http://mia-moda.de/Container?langId=-3&storeId=510004&",
                            subjectRedirect: !0
                        },
                        analytics: {
                            vendors: {
                        ...
                        displaycode: "13384",
                        implementationID: "49cb011a-dd83-4ca5-9a4b-9cf3a2675af2",
                        clientname: "mia-moda",
                        clientDisplayName: "Ihr MIAMODA-Team",
                        siteAuth: {
                            review: !1,
                            comment: !1,
                            question: !1,
                        ...
                        loginPage: "",
                        experiments: {},
                        clientLogo: "http://image.sa.bazaarvoice.com/lib/fe5f15707d63067f711c/m/1/vg0iy7fet0i9sDMd06bG.gif",
                        sort: {
                            reviews: "mostRecent",
                        ...
                        contentLocales: [],
                        revision: "482-56f26e80b1bef309edb5fce8",
                        site: "Main Site",
                        prefetchConfigs: [{
                            url: "//api.bazaarvoice.com/data/batch.json?passkey=9ro13m3wxgw846x5bsgvz59q7&apiversion=5.5&displaycode=13384-de_de&resource.q0=products&filter.q0=id%3Aeq%3A___PRODUCTIDTOKEN___&stats.q0=reviews&filteredstats.q0=reviews&filter_reviews.q0=contentlocale%3Aeq%3Ade_DE&filter_reviewcomments.q0=contentlocale%3Aeq%3Ade_DE&resource.q1=reviews&filter.q1=isratingsonly%3Aeq%3Afalse&filter.q1=productid%3Aeq%3A___PRODUCTIDTOKEN___&filter.q1=contentlocale%3Aeq%3Ade_DE&sort.q1=submissiontime%3Adesc&stats.q1=reviews&filteredstats.q1=reviews&include.q1=authors%2Cproducts%2Ccomments&filter_reviews.q1=contentlocale%3Aeq%3Ade_DE&filter_reviewcomments.q1=contentlocale%3Aeq%3Ade_DE&filter_comments.q1=contentlocale%3Aeq%3Ade_DE&limit.q1=4&offset.q1=0&limit_comments.q1=3",
                            subQueries: ["//api.bazaarvoice.com/data/products.json?passkey=9ro13m3wxgw846x5bsgvz59q7&apiversion=5.5&displaycode=13384-de_de&filter=id%3Aeq%3A___PRODUCTIDTOKEN___&stats=reviews&filteredstats=reviews&filter_reviews=contentlocale%3Aeq%3Ade_DE&filter_reviewcomments=contentlocale%3Aeq%3Ade_DE", "//api.bazaarvoice.com/data/reviews.json?passkey=9ro13m3wxgw846x5bsgvz59q7&apiversion=5.5&displaycode=13384-de_de&filter=isratingsonly%3Aeq%3Afalse&filter=productid%3Aeq%3A___PRODUCTIDTOKEN___&filter=contentlocale%3Aeq%3Ade_DE&sort=submissiontime%3Adesc&stats=reviews&filteredstats=reviews&include=authors%2Cproducts%2Ccomments&filter_reviews=contentlocale%3Aeq%3Ade_DE&filter_reviewcomments=contentlocale%3Aeq%3Ade_DE&filter_comments=contentlocale%3Aeq%3Ade_DE&limit=4&offset=0&limit_comments=3"]
                        }]
                    }
                },
                version: 26,
            ...
            i = function(e, t, n, r, i) {
                ...
                return function(u) {
                    var a = u._internal
                        ...
                        loader: n.loadScript,
                        namespace: u,
                        env: s(u.options.workspace)
                    });
                    f.require(["jquery-bv@1.11.1", "lodash-bv@1.2.0"], function() {});
                    var l, c, h = r.document.getElementsByTagName("head")[0], p = a.baseUrl + "/stylesheets/", d = t && t > 4 && 9 > t, v = p + (a.preview ? "cleanslate" : d ? "screen-ie" : "screen") + ".css";
                    l = "bv-primary.js",
                        c = {},
                        n.loadScript('http://www.mia-moda.catalogi.ru/static/bv-primary.js', c);
                    var m = {};
                    return h && (m.injectionNode = h),
                    !a.preview && d && (a.loadCSS = function() {
                            n.loadStyleSheet(v, m)
                        }
                    ),
                        n.loadStyleSheet(v, m),
                        e.each(u.options.externalFeatures, function(t) {
        ...
        e.exports = {
            ...
            loadStyleSheet: function(e, t, n) {
                ...
                if ("function" == typeof t && (n = t,
                        ...
                        t.timeout = t.timeout || a,
                        s(e, t, n),
                    "injectionNode" in t && (!t.injectionNode.nodeType || 1 !== t.injectionNode.nodeType))
                    throw new Error("`options.injectionNode` must be a DOM node");
                var f, l = u.createElement("link"), h = !1;
                if (t.attributes)
                    for (f in t.attributes)
                        l.setAttribute(f, t.attributes[f]);
                l.onreadystatechange = l.onload = function() {
    ...
    , function(e, t) {
        ...
        e.exports = function(e) {
            function t(e) {
                return c + encodeURIComponent(e.sort().join("+")) + ".js"
            }
            function u(e, t, r) {
                r ? h.responses[e] = [t, r] : (r = t,
                    h.responses[e] = [r]),
                    n(h.requests[e], function(t) {
                        t(h.responses[e])
                    }),
                    h.requests[e] = null
            }
                ...
                require: function(e, i) {
                    function s() {
                        function t(e) {
                            ...
                            if (!r)
                                return !1;
                            var s = 2 === r.length ? r[0] : [];
                            return 0 === s.length ? !0 : (n(s, function(e) {
                                i = t(e)
                            }),
                                i)
                        }
                    ...
                    function o(e) {
                        ...
                        i || (i = n,
                            n = []);
                        var s = r(n, o);
                        return s.length ? i.apply(null , s) : i()
                    }
                    i = i || function() {}
                    ;
                    var u = [];
                    n(e, function(e) {
                        return h.responses[e] ? void s() : h.requests[e] ? void h.requests[e].push(s) : (h.requests[e] = [s],
                            void u.push(e))
                    }),
                    u.length && a(t(u), function(e) {
                        if (e)
                            throw new Error("Failed to load " + u.join(", "))
                    })
                },
                define: u
            };
            return h.require = p.require,
                p
        }
    }
    , function(e, t, n) {
            ...
            i = function(e) {
                ...
                return function(e, n) {
                    ...
                    return function() {
                        ...
                        var o, u = n || [], a = r.extensionsRegistry;
                        r.timing = {
                            ui: {}
                        };
                        var f = {
                            ...
                            push: function(t) {
                                var n, o, u, a = t[0], l = t[1];
                                if (("ui" === a || "configure" === a) && (n = "ui" === a ? t[3] : t[2],
                                        o = "ui" === a ? t[2] : null ,
                                    n && e._internal.preload && n.productId && i(a, l, o) && (r.preload(n.productId),
                                        r.preload = null ),
                                        u = s(a, l, o)),
                                    "ui" === a) {
                                    var c = (l + "_" + o).toLowerCase();
                                    e.performance.mark(c + "-call"),
                                        r.timing = r.timing || {
                                                ui: {}
                                            },
                                        r.timing.ui[c] = {
                            ...
                            !function(e, t, n) {
                                ...
                                e[s] = function(e) {
                                    return function() {
                                        ...
                                        if ("ui" === e) {
                                            var n = t[3] = t[3] || {};
                                            return n.loadedDeferred = n.loadedDeferred || r._.Deferred(),
                                                f.push(t),
                                                n.loadedDeferred.promise()
                                        }
                                        return f.push(t)
                                    }
                                }(t.replace(/\./g, "_"))
    ...
    , function(e, t, n) {
        function r(e, t, n) {
            this.isStaging = !!t,
                this.eventQueue = n,
                this.configureMagpie(),
            e && (this.data.bvProduct = e),
            n && this.processEventQueue()
        }
        function i(e, t, n, i) {
            if (!s.isObject(e))
                throw new Error("Undefined Host Object for SetUser");
            if (!s.isObject(window._bvaq))
                throw new Error("No magpie event queue is defined");
            var o = new r(t,n,i);
            e.setUser = function() {
        ...
        n(27),
            ...
            r.prototype.configureMagpie = function() {
                window._bvaq.length || (window._bvaq.push(["setSource", "ProfileWeb"]),
                    window._bvaq.push(["setEnvironment", "production"]),
                    window._bvaq.push(["setStaging", this.isStaging])),
                    window._bvaq.push(["setAnonymous", !1])
            }
            ,
            r.prototype.setUser = function(e) {
                var t = this.data;
                t.profileId = e,
                    t.magpieJsVersion = window._bvaq.version,
                    window._bvaq.push(["trackEvent", o, t])
            }
            ,
            ...
            r.prototype.processEventQueue = function() {
                ...
                if (s.isArray(this.eventQueue))
                    for (var t = 0; t < this.eventQueue.length; t++)
                        switch (e = this.eventQueue.shift(),
                            e.method) {
                            case "setUser":
